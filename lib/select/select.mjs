import "./css.mjs";
import { withDirectives as pt, openBlock as w, createElementBlock as M, normalizeClass as ut, normalizeStyle as Kt, createElementVNode as x, withModifiers as G, renderSlot as xt, vShow as ft, resolveComponent as ne, createBlock as oe, Transition as _t, withCtx as st, createVNode as Z, toDisplayString as J, createCommentVNode as re, Fragment as bt, renderList as wt, camelize as ae, h as St, render as Mt, isVNode as Et, mergeProps as he } from "vue";
/*!
...
function pe(e) {
  e.prototype.on = function(t, i) {
    ...
    if (i)
      for (var s = i.length, n = [].concat(ce(i)), o = 0; o < s; o++) {
        var r = n[o], a = le(r, 2), h = a[0], l = a[1];
        h && h.apply(l, [].slice.call(arguments, 1));
      }
  };
}
var X = typeof window < "u", Q = X && navigator.userAgent.toLowerCase(), ue = Q && /wechatdevtools/.test(Q), fe = Q && Q.indexOf("android") > 0;
function P() {
...
var gt = X && document.createElement("div").style, nt = function() {
  if (!X)
    return !1;
  var e = {
...
function Y(e) {
  return nt === !1 ? !1 : nt === "standard" ? e === "transitionEnd" ? "transitionend" : e : nt + e.charAt(0).toUpperCase() + e.substr(1);
}
function tt(e, t, i, s) {
...
var Gt = Y("transform"), de = X && Y("perspective") in gt, mt = X && ("ontouchstart" in window || ue), me = Gt !== !1, ge = X && Y("transition") in gt, _ = {
  transform: Gt,
...
function Zt(e) {
  ...
  if (typeof MouseEvent < "u")
    ...
    a();
  function a() {
    n = document.createEvent("Event"), n.initEvent(t, o, r), z(n, s);
  }
...
function be(e) {
  e.prototype._init = function(t, i) {
    ...
    t(window, "orientationchange", this), t(window, "resize", this), this.options.click && t(this.wrapper, "click", this, !0), this.options.disableMouse || (t(this.wrapper, "mousedown", this), t(i, "mousemove", this), t(i, "mousecancel", this), t(i, "mouseup", this)), mt && !this.options.disableTouch && (t(this.wrapper, "touchstart", this), t(i, "touchmove", this), t(i, "touchcancel", this), t(i, "touchend", this)), t(this.scroller, _.transitionEnd, this);
...
var rt = function() {
  ...
  function(e) {
    return window.setTimeout(e, (e.interval || we) / 2);
  } : Jt;
}(), D = function() {
...
function Se(e) {
  e.prototype._start = function(t) {
    var i = $[t.type];
    if (!(i !== U && t.button !== 0) && !(!this.enabled || this.destroyed || this.initiated && this.initiated !== i)) {
    ...
    if (!(!this.enabled || this.destroyed || $[t.type] !== this.initiated)) {
      ...
      var o = Math.abs(this.distX), r = Math.abs(this.distY), a = P();
      if (!(a - this.endTime > this.options.momentumLimitTime && r < this.options.momentumLimitDistance && o < this.options.momentumLimitDistance)) {
        ...
        s = this.hasHorizontalScroll ? s : 0, n = this.hasVerticalScroll ? n : 0, this.movingDirectionX = s > 0 ? ht : s < 0 ? at : 0, this.movingDirectionY = n > 0 ? F : n < 0 ? W : 0;
        ...
        var m = document.documentElement.scrollLeft || window.pageXOffset || document.body.scrollLeft, y = document.documentElement.scrollTop || window.pageYOffset || document.body.scrollTop, E = this.pointX - m, S = this.pointY - y;
        (E > document.documentElement.clientWidth - this.options.momentumLimitDistance || E < this.options.momentumLimitDistance || S < this.options.momentumLimitDistance || S > document.documentElement.clientHeight - this.options.momentumLimitDistance) && this._end(t);
      }
    }
    ...
    if (!(!this.enabled || this.destroyed || $[t.type] !== this.initiated)) {
      ...
      if (this.directionX = n > 0 ? ht : n < 0 ? at : 0, this.directionY = o > 0 ? F : o < 0 ? W : 0, !(this.options.pullDownRefresh && this._checkPullDown())) {
        if (this._checkClick(t)) {
          this.trigger("scrollCancel");
          return;
        }
        if (!this.resetPosition(this.options.bounceTime, T.bounce)) {
          this._translate(i, s), this.endTime = P();
          ...
          if (this.options.momentum && r < this.options.momentumLimitTime && (h > this.options.momentumLimitDistance || a > this.options.momentumLimitDistance)) {
            ...
            var m = this.directionX === ht && d || this.directionX === at && f ? this.wrapperWidth : 0, y = this.directionY === F && u || this.directionY === W && p ? this.wrapperHeight : 0, E = this.hasHorizontalScroll ? Xt(this.x, this.startX, r, this.maxScrollX, this.minScrollX, m, this.options) : { destination: i, duration: 0 }, S = this.hasVerticalScroll ? Xt(this.y, this.startY, r, this.maxScrollY, this.minScrollY, y, this.options) : { destination: s, duration: 0 };
            i = E.destination, s = S.destination, l = Math.max(E.duration, S.duration), this.isInTransition = !0;
          } else
          ...
          if (this.options.snap) {
            ...
            this.currentPage = C, l = this.options.snapSpeed || Math.max(Math.max(Math.min(Math.abs(i - C.x), 1e3), Math.min(Math.abs(s - C.y), 1e3)), 300), i = C.x, s = C.y, this.directionX = 0, this.directionY = 0, it = this.options.snap.easing || T.bounce;
          }
          if (i !== this.x || s !== this.y) {
            (i > this.minScrollX || i < this.maxScrollX || s > this.minScrollY || s < this.maxScrollY) && (it = T.swipeBounce), this.scrollTo(i, s, l, it);
            return;
          }
    ...
    if (this.stopFromTransition = !1, !this.moved)
      if (this.options.wheel) {
        if (this.target && this.target.classList.contains(this.options.wheel.wheelWrapperClass)) {
          var s = Math.abs(Math.round(this.y / this.itemHeight)), n = Math.round((this.pointY + dt(this.wrapper).top - this.wrapperHeight / 2) / this.itemHeight);
        ...
        if (!i) {
          ...
          if (o && this.lastClickTime) {
            ...
            P() - this.lastClickTime < h && (r = !0, ye(t));
          }
          return this.options.tap && ve(t, this.options.tap), this.options.click && !V(t.target, this.options.preventDefaultException) && Zt(t), this.lastClickTime = r ? null : P(), !0;
        }
        return !1;
      }
    return !1;
    ...
    D(this.probeTimer), this.probeTimer = rt(i);
    var t = this;
    function i() {
    ...
    if (this.scrollerStyle[_.transitionDuration] = t + "ms", this.options.wheel)
      for (var i = 0; i < this.items.length; i++)
        this.items[i].style[_.transitionDuration] = t + "ms";
    if (this.indicators)
    ...
    if (this.scrollerStyle[_.transitionTimingFunction] = t, this.options.wheel)
      for (var i = 0; i < this.items.length; i++)
        this.items[i].style[_.transitionTimingFunction] = t;
    if (this.indicators)
      for (var s = 0; s < this.indicators.length; s++)
    ...
    if (q(!R(t) && !R(i), "Translate x or y is null or undefined."), R(s) && (s = this.scale), this.options.useTransform ? this.scrollerStyle[_.transform] = "translate(" + t + "px," + i + "px) scale(" + s + ")" + this.translateZ : (t = Math.round(t), i = Math.round(i), this.scrollerStyle.left = t + "px", this.scrollerStyle.top = i + "px"), this.options.wheel)
      for (var n = this.options.wheel.rotate, o = n === void 0 ? 25 : n, r = 0; r < this.items.length; r++) {
        var a = o * (i / this.itemHeight + r);
        this.items[r].style[_.transform] = "rotateX(" + a + "deg)";
      }
    ...
    var o = this, r = this.x, a = this.y, h = this.lastScale, l = this.scale, u = P(), p = u + s;
    function d() {
      var f = P();
      if (f >= p) {
      ...
      f = (f - u) / s;
      var c = n(f), m = (t - r) * c + r, y = (i - a) * c + a, E = (l - h) * c + h;
      o._translate(m, y, E), o.isAnimating && (o.animateTimer = rt(d)), o.options.probeType === H && o.trigger("scroll", {
        x: o.x,
        y: o.y
      });
    }
    ...
    return this.options.useTransform ? (t = t[_.transform].split(")")[0].split(", "), i = +(t[12] || t[4]), s = +(t[13] || t[5])) : (i = +t.left.replace(/[^-\d.]/g, ""), s = +t.top.replace(/[^-\d.]/g, "")), {
      x: i,
      y: s
    };
...
function Me(e) {
  e.prototype._initSnap = function() {
    ...
    if (i.loop) {
      ...
      s.length > 1 ? (Te(s[s.length - 1].cloneNode(!0), this.scroller), this.scroller.appendChild(s[1].cloneNode(!0))) : i.loop = !1;
    }
    var n = i.el;
      ...
      if (t.pages = [], !(!t.wrapperWidth || !t.wrapperHeight || !t.scrollerWidth || !t.scrollerHeight)) {
        ...
        if (n)
          for (d = n.length, c = -1; p < d; p++)
            m = k(n[p]), (p === 0 || m.left <= k(n[p - 1]).left) && (f = 0, c++), t.pages[f] || (t.pages[f] = []), a = Math.max(-m.left, t.maxScrollX), h = Math.max(-m.top, t.maxScrollY), l = a - Math.round(m.width / 2), u = h - Math.round(m.height / 2), t.pages[f][c] = {
              x: a,
              y: h,
              width: m.width,
              height: m.height,
        ...
        var S = i.threshold;
        S % 1 === 0 ? (t.snapThresholdX = S, t.snapThresholdY = S) : (t.snapThresholdX = Math.round(t.pages[t.currentPage.pageX][t.currentPage.pageY].width * S), t.snapThresholdY = Math.round(t.pages[t.currentPage.pageX][t.currentPage.pageY].height * S));
      }
...
function Ee(e) {
  e.prototype.wheelTo = function() {
    ...
    t.wheelWrapperClass || (t.wheelWrapperClass = "wheel-scroll"), t.wheelItemClass || (t.wheelItemClass = "wheel-item"), t.selectedIndex === void 0 && (t.selectedIndex = 0, B("wheel option selectedIndex is required!"));
  };
}
var I = 8;
function Pe(e) {
...
g.prototype.fade = function(e, t) {
  ...
  if (!(t && !this.visible)) {
    var s = e ? 250 : 500;
    e = e ? "1" : "0", this.wrapperStyle[_.transitionDuration] = s + "ms", clearTimeout(this.fadeTimeout), this.fadeTimeout = setTimeout(function() {
...
g.prototype.updatePosition = function() {
  if (this.direction === "vertical") {
    ...
    this.y = e, this.scroller.options.useTransform ? this.indicatorStyle[_.transform] = "translateY(" + e + "px)" + this.scroller.translateZ : this.indicatorStyle.top = e + "px";
  } else {
...
g.prototype.transitionTime = function() {
  ...
  this.indicatorStyle[_.transitionDuration] = e + "ms";
};
g.prototype.transitionTimingFunction = function(e) {
  this.indicatorStyle[_.transitionTimingFunction] = e;
};
...
g.prototype._start = function(e) {
  ...
  e.preventDefault(), e.stopPropagation(), this.transitionTime(), this.initiated = !0, this.moved = !1, this.lastPointX = t.pageX, this.lastPointY = t.pageY, this.startTime = P(), this._handleMoveEvents(tt), this.scroller.trigger("beforeScrollStart");
};
...
g.prototype._end = function(e) {
  if (this.initiated) {
    this.initiated = !1, e.preventDefault(), e.stopPropagation(), this._handleMoveEvents(et);
...
function Ye(e) {
  e.prototype._initPullDown = function() {
    ...
    return this.directionY !== F || this.y < s ? !1 : (this.pulling || (this.pulling = !0, this.trigger("pullingDown")), this.scrollTo(this.x, o, this.options.bounceTime, T.bounce), this.pulling);
...
function De(e) {
  e.prototype._initMouseWheel = function() {
    var t = this;
    this._handleMouseWheelEvent(tt), this.on("destroy", function() {
      clearTimeout(t.mouseWheelTimer), clearTimeout(t.mouseWheelEndTimer), t._handleMouseWheelEvent(et);
...
function ke(e) {
  e.prototype._initZoom = function() {
    ...
    this.scale = Math.min(Math.max(s, o), a), this.setScale(this.scale), this.scrollerStyle[_.transformOrigin] = "0 0";
    ...
    var n = dt(this.wrapper), o = n.left, r = n.top, a = i + o - this.x, h = s + r - this.y;
    this._zoomTo(t, a, h);
  }, e.prototype._zoomStart = function(t) {
    var i = t.touches[0], s = t.touches[1], n = Math.abs(i.pageX - s.pageX), o = Math.abs(i.pageY - s.pageY);
    this.startDistance = Pt(n, o), this.startScale = this.scale;
    var r = dt(this.wrapper), a = r.left, h = r.top;
    ...
    if (!(!this.enabled || this.destroyed || $[t.type] !== this.initiated)) {
      this.options.preventDefault && t.preventDefault(), this.options.stopPropagation && t.stopPropagation();
      var i = t.touches[0], s = t.touches[1], n = Math.abs(i.pageX - s.pageX), o = Math.abs(i.pageY - s.pageY), r = Pt(n, o), a = r / this.startDistance * this.startScale;
      this.scaled = !0;
...
v.prototype.onScroll = function() {
  ...
  t < 0 ? (s -= It, n += Ct) : (s -= Ct, n += It), this.fill(s, n), this.maybeRequestContent();
};
...
v.prototype._removeTombstones = function() {
  for (var e = void 0, t = 0, i = this.items.length, s = 0; s < i; s++) {
    ...
    (!n || vt(n)) && !o && (e || (e = s), n && this.scrollerEl.removeChild(n));
  }
...
v.prototype._collectUnusedNodes = function() {
  for (var e = [], t = 0; t < this.items.length; t++) {
    ...
    i && (vt(i) ? (this.tombstones.push(i), this.tombstones[this.tombstones.length - 1].style.display = "none") : e.push(i)), this.items[t].node = null;
  }
  return e;
};
...
v.prototype._setupAnimations = function(e, t) {
  ...
  for (var s in e) {
    var n = e[s];
    this.items[s].node.style.transform = "translateY(" + (this.anchorScrollTop + n[1]) + "px) scale(" + this.tombstoneWidth / this.items[s].width + ", " + this.tombstoneHeight / this.items[s].height + ")", this.items[s].node.offsetTop, n[0].offsetTop, this.items[s].node.style.transition = "transform " + N + "ms";
  }
  for (var o = this.firstAttachedItem; o < this.lastAttachedItem; o++) {
    var r = e[o];
    if (r) {
      var a = r[0];
      a.style.transition = "transform " + N + "ms, opacity " + N + "ms", a.style.transform = "translateY(" + t + "px) scale(" + this.items[o].width / this.tombstoneWidth + ", " + this.items[o].height / this.tombstoneHeight + ")", a.style.opacity = 0;
    }
...
function b(e, t) {
  this.wrapper = typeof e == "string" ? document.querySelector(e) : e, this.wrapper || B("Can not resolve the wrapper DOM."), this.scroller = this.wrapper.children[0], this.scroller || B("The wrapper need at least one child element to be scroller."), this.scrollerStyle = this.scroller.style, this._init(e, t);
}
be(b);
Se(b);
pe(b);
...
const yt = (e, t) => {
  ...
  for (const [s, n] of t)
    i[s] = n;
  return i;
}, Ce = "cube-popup", Wt = "mask-click", Le = {
  name: Ce,
  mixins: [Bt, te],
  emits: [Wt],
  props: {
  ...
  methods: {
    maskClick(e) {
      this.$emit(Wt, e), this.maskClosable && this.hide();
    }
  }
}, We = {
  key: 0,
...
function $e(e, t, i, s, n, o) {
  return pt((w(), M("div", {
    class: ut(["cube-popup", o.rootClass]),
    style: Kt({ "z-index": e.zIndex })
  }, [
    x("div", {
    ...
    x("div", {
      class: ut(["cube-popup-container", o.containerClass]),
      onTouchmove: t[2] || (t[2] = G(() => {
      }, ["prevent"]))
    }, [
      e.$slots.default ? (w(), M("div", We, [
        xt(e.$slots, "default")
      ])) : (w(), M("div", {
        key: 1,
        class: "cube-popup-content",
...
const He = /* @__PURE__ */ yt(Le, [["render", $e]]), lt = {
  value: "value",
  text: "text",
  order: "order"
}, ze = {
  ...
  computed: {
    valueKey() {
      return this.alias.value || lt.value;
    },
    textKey() {
      return this.alias.text || lt.text;
    },
    orderKey() {
      return lt.order;
    },
...
const Tt = ee("Undefined"), Ke = ee("Number");
function je(e, t, i, s) {
  const n = {
    year: "(Y+)",
    month: "(M+)",
  ...
  if (new RegExp(n[e], s).test(t)) {
    const o = e === "year" ? i.toString().substr(4 - RegExp.$1.length) : RegExp.$1.length === 1 ? i : Ge(i);
...
function Ze(e, t) {
  ...
  for (const s in i)
    t = je(s, t, i[s].value, i[s].regExpAttributes);
  return t;
}
let L;
const At = "zh-CN", A = {
  name: "locale",
  install(e) {
    A.installed || (L = e.config.globalProperties, L.$cubeLang = At, L.$cubeMessages = { [At]: Ne, "en-US": Re }, A.installed = !0);
  },
  use(e, t) {
    L.$cubeLang = e;
  ...
  helpers: {
    toLocaleDateString(e, t) {
      const i = Ke(e) ? e : e.replace(/-/g, "/"), s = new Date(i);
      return Tt(t) ? s.toDateString() : Ze(s, t);
    }
  },
  addHelper(e, t) {
    e in A.helpers || (A.helpers[e] = t);
  }
}, ie = A, Je = "Translation is not registered correctly, you can call Locale.use() to install it.", se = {
  computed: {
    $t() {
      const e = this.$cubeLang, t = this.$cubeMessages[e];
      return Tt(t) ? (Ue(Je), "") : (i) => Fe(t, i);
    }
  },
  beforeCreate() {
    ie.install(this._.appContext.app);
  }
}, Qe = typeof window < "u", O = Qe && navigator.userAgent.toLowerCase();
O && O.indexOf("android") > 0;
const Be = O && /iphone|ipad|ipod|ios/.test(O);
function ti() {
  let e = !0;
  if (Be) {
    const t = qe(O);
...
const $t = ti();
const ei = "cube-picker", Ht = "select", zt = "value-change", Ot = "cancel", Nt = "change", ii = {
  name: ei,
  mixins: [Bt, te, ze, Oe, se],
  emits: [Ht, zt, Ot, Nt],
  props: {
    pending: {
      type: Boolean,
  ...
  methods: {
    confirm() {
      ...
      this.$emit(Ht, this._values, this._indexes, t), e && this.$emit(zt, this._values, this._indexes, t);
    },
    maskClick() {
      this.maskClosable && this.cancel();
    },
    cancel() {
      this.hide(), this.$emit(Ot);
    },
    show() {
      if (!this.isVisible)
    ...
    _createWheel(e, t) {
      if (this.wheels[t])
        ...
        const i = this.wheels[t] = new b(e.children[t], {
          wheel: {
        ...
        i.on("scrollEnd", () => {
          this.$emit(Nt, t, this._getSelectIndex(i));
        });
      }
    ...
    _getSelectIndex(e) {
      const t = e.y;
      let i;
      return $t ? i = e.getSelectedIndex() : t > e.minScrollY ? i = 0 : t < e.maxScrollY ? i = e.items.length - 1 : i = Math.round(Math.abs(t / e.itemHeight)), i;
    }
  },
  beforeUnmount() {
...
}, si = { class: "cube-picker-choose border-bottom-1px" }, ni = { class: "cube-picker-title-group" }, oi = ["innerHTML"], ri = ["innerHTML"], ai = { class: "cube-picker-content" }, hi = /* @__PURE__ */ x("i", { class: "border-bottom-1px" }, null, -1), li = /* @__PURE__ */ x("i", { class: "border-top-1px" }, null, -1), ci = {
  class: "cube-picker-wheel-wrapper",
  ref: "wheelWrapper"
}, pi = { class: "cube-picker-wheel-scroll" }, ui = ["innerHTML"], fi = /* @__PURE__ */ x("div", { class: "cube-picker-footer" }, null, -1);
function di(e, t, i, s, n, o) {
  const r = ne("cube-popup");
  return w(), oe(_t, { name: "cube-picker-fade" }, {
    default: st(() => [
      pt(Z(r, {
        type: "picker",
        mask: !0,
            ...
            default: st(() => [
              pt(x("div", {
                ...
                x("div", ai, [
                  ...
                  li,
                  x("div", ci, [
                    (w(!0), M(bt, null, wt(n.finalData, (a, h) => (w(), M("div", {
                      key: h,
                      style: Kt({ order: o._getFlexOrder(a) })
                    }, [
                      x("ul", pi, [
                        (w(!0), M(bt, null, wt(a, (l, u) => (w(), M("li", {
...
const K = /* @__PURE__ */ yt(ii, [["render", di]]);
const mi = "cube-select", Rt = "change", Ut = "update:modelValue", Vt = "picker-show", Ft = "picker-hide", gi = {
  name: mi,
  mixins: [se],
  emits: [Rt, Ut, Vt, Ft],
  props: {
  ...
  computed: {
    ...
    valueIndex() {
      const e = this.modelValue, t = Ve(this.adaptOptions[0], (i) => i.value === e);
  ...
  methods: {
    showPicker() {
      this.disabled || (this.picker.show(), this.active = !0, this.$emit(Vt));
    },
    hided() {
      this.active = !1, this.$emit(Ft);
    },
    selectHandler(e, t, i) {
      this.hided(), e[0] !== this.modelValue && (this.$emit(Ut, e[0]), this.$emit(Rt, e[0], t[0], i[0]));
    }
  }
}, vi = {
  key: 0,
...
}, Ti = /* @__PURE__ */ x("i", { class: "cube-select-icon" }, null, -1);
function xi(e, t, i, s, n, o) {
  return w(), M("div", {
    class: ut(["cube-select", { "cube-select_active": n.active, "cube-select_disabled": i.disabled }]),
    onClick: t[0] || (t[0] = (...r) => o.showPicker && o.showPicker(...r))
  }, [
    o.selectedText ? (w(), M("span", vi, J(o.selectedText), 1)) : (w(), M("span", yi, J(o._placeholder), 1)),
    Ti
  ], 2);
}
const j = /* @__PURE__ */ yt(gi, [["render", xi]]);
let _i = 0;
const ct = [], bi = (e, t, i = null, s = null) => {
  let n = t, o = i ? i(St) : null;
  const r = document ? document.createElement("div") : null, a = "cube_create_component_" + _i++, h = Z({
    render() {
      return Z(e, {
        ...n
        // ref: '$cre'
  ...
  s && (h.appContext = s), ct.push(h);
  let l;
  return r && (Mt(h, r), l = h.component.subTree.component.proxy, l.$remove = function(u) {
    Mt(null, r), e._instance = null, u && u(), r && document.body.contains(r) && document.body.removeChild(r);
    const p = ct.findIndex((d) => {
      const { id: f } = d.props;
      return a === f;
    });
    ~p && ct.splice(p, 1);
  }, l.$updateProps = function(u, p, d = !0) {
    n = { ...d ? n : {}, ...u }, o = p ? { ...o || {}, ...p(St) } : null, h.component.proxy.$forceUpdate();
  }, document.body.appendChild(r)), l;
};
function qt(e) {
  if (!!this && !!this._ && Et(this._.vnode)) {
    const i = this && this._ && Et(this._.vnode) ? this._.vnode.props : null;
    this._.vnode.props = he(i || {}, {
...
function wi(e, t, i, s) {
  t.$create = e.config.globalProperties[`$create${ae(t.name.replace("cube-", "")).replace(/^\w/, (n) => n.toUpperCase())}`] = function(n, o = null) {
    if (s && t._instance)
      return n && t._instance.$updateProps(n, o, !1), qt.call(this, t._instance), t._instance;
    const r = t._instance = bi(t, n, o, this ? this._.appContext : null);
    return qt.call(this, r), r;
  };
}
function Si(e, t) {
  wi(e, t);
...
j.install = function(e) {
  e.component(K.name, K), e.component(j.name, j), ie.install(e), Si(e, K);
};
j.Picker = K;
export {
  j as default
