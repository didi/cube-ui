...
const Nf = oe.Group, Pf = oe.Item, If = Ee.Item, Co = xe.Radio, Df = We.Item, Vf = pe.Panel, Of = pe.Item, Hf = Se.Ele, Af = ke.Panel, Lf = Re.Tab, Yf = Xe.Panel, Rf = Te.Item, Mo = [
  // locale
  X,
  // basic
  se,
