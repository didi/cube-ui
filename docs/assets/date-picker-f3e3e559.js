import{a as e,o as d,j as n}from"./index-9017f177.js";const o={class:"markdown-body"},a=n(`<h2>DatePicker</h2><blockquote><p>New in 1.7.0+</p></blockquote><p>DatePicker can be used to choose date, which has flexible configuration for time granularity, such as year - month - date, hour - minute - second, year - month - date - hour - minute - second, year - month, etc.</p><p><strong>Notice:</strong> Cause this component used create-api, so you should read <a href="#/en-US/docs/create-api">create-api</a> first.</p><h3>Example</h3><ul><li><p>Basic usage</p><p>You can create a component instance by <code>$createDatePicker</code>, and configure <code>min</code>, <code>max</code> to set the selected date range. the <code>value</code> could use to set the current selected date.</p><pre><code class="language-html">&lt;cube-button @click=&quot;showDatePicker&quot;&gt;Date Picker&lt;/cube-button&gt;
