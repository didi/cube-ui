import{a as e,o as d,j as o}from"./index-e8a96955.js";const n={class:"markdown-body"},r=o(`<h2>Dialog</h2><p><code>Dialog</code>模态框组件，提供了多种样式及交互形式。</p><p><strong>注：</strong> 由于此组件基于 create-api 实现，所以在使用之前，请确保自己了解过 <a href="#/zh-CN/docs/create-api">create-api</a>。</p><h3>示例</h3><ul><li><p>alert 类型</p><pre><code class="language-html">&lt;cube-button @click=&quot;showAlert&quot;&gt;Dialog - alert&lt;/cube-button&gt;
