import{a as e,o as n,j as d}from"./index-9017f177.js";const a={class:"markdown-body"},i=d(`<h2>ImagePreview</h2><blockquote><p>1.10.0 新增</p></blockquote><p>图片预览，支持切换、放大缩小等能力。</p><p><strong>注：</strong> 由于此组件基于 create-api 实现，所以在使用之前，请确保自己了解过 <a href="#/zh-CN/docs/create-api">create-api</a>。</p><h3>示例</h3><p>如下示例相关代码在<a href="https://github.com/didi/cube-ui/tree/master/example/pages/image-preview">这里</a>。</p><ul><li><p>默认使用</p><pre><code class="language-html">&lt;cube-button @click=&quot;showImagePreview&quot;&gt;Show ImagePreview&lt;/cube-button&gt;
