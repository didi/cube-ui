import{a as e,o,j as s}from"./index-e8a96955.js";const d={class:"markdown-body"},a=s(`<h2>Toast</h2><p><code>Toast</code>组件主要用于非模态信息提醒，无需用户交互。</p><p><strong>注：</strong> 由于此组件基于 create-api 实现，所以在使用之前，请确保自己了解过 <a href="#/zh-CN/docs/create-api">create-api</a>。</p><h3>示例</h3><ul><li><p>显示时间设置</p><pre><code class="language-html">&lt;cube-button @click=&quot;showToastTime&quot;&gt;Toast - time 1s&lt;/cube-button&gt;
