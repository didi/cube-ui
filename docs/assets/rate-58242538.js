import{a as e,o as a,j as d}from"./index-9017f177.js";const o={class:"markdown-body"},r=d(`<h2>Rate</h2><blockquote><p>New in 1.5.0+</p></blockquote><p>Rate component. You can customize the rating star numbers, and disable the interaction, you can also customize the style of star through the slot.</p><h3>Example</h3><ul><li><p>Basic usage</p><p>You can use the v-model directive to create two-way data bindings.</p><pre><code class="language-html">&lt;cube-rate v-model=&quot;value&quot;&gt;&lt;/cube-rate&gt;
