import{a as e,o as d,j as n}from"./index-9017f177.js";const o={class:"markdown-body"},l=n(`<h2>Form</h2><blockquote><p>New in 1.7.0+</p><p>1.8.0+ supported trigger validating when blur and debounce. Supported async validate too because of Validator supported it.</p></blockquote><p>CubeForm is a schema-based form generator component.</p><h3>Example</h3><ul><li><p>default usage</p><p>This demo includes all cube-ui form fields.</p><pre><code class="language-html">&lt;cube-form
  :model=&quot;model&quot;
  :schema=&quot;schema&quot;
