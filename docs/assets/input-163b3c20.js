import{a as e,o as d,j as o}from"./index-9017f177.js";const a={class:"markdown-body"},l=o(`<h2>Input</h2><blockquote><p>1.5.0 新增</p></blockquote><p>输入框组件。支持使用<code>v-model</code>对数据双向绑定，支持一键清空内容。</p><h3>示例</h3><ul><li><p>基本用法</p><p>使用<code>v-model</code>对输入内容双向绑定。</p><pre><code class="language-html">&lt;cube-input v-model=&quot;value&quot; &gt;&lt;/cube-input&gt;
