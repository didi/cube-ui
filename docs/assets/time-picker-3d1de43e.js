import{a as e,o as d,j as n}from"./index-9017f177.js";const c={class:"markdown-body"},o=n(`<h2>TimePicker组件</h2><p><code>TimePicker</code>组件提供了常用的日期选择功能。</p><p><strong>注：</strong> 由于此组件基于 create-api 实现，所以在使用之前，请确保自己了解过 <a href="#/zh-CN/docs/create-api">create-api</a>。</p><h3>示例</h3><ul><li><p>基本用法</p><pre><code class="language-html">&lt;cube-button @click=&quot;showTimePicker&quot;&gt;TimePicker&lt;/cube-button&gt;
