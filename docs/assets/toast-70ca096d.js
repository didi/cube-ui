import{a as e,o,j as s}from"./index-e8a96955.js";const a={class:"markdown-body"},n=s(`<h2>Toast</h2><p><code>Toast</code> component.You can use it to show non-modal tip message without user interaction.</p><p><strong>Notice:</strong> Cause this component used create-api, so you should read <a href="#/en-US/docs/create-api">create-api</a> first.</p><h3>Example</h3><ul><li><p>Duration of display</p><pre><code class="language-html">&lt;cube-button @click=&quot;showToastTime&quot;&gt;Toast - time 1s&lt;/cube-button&gt;
