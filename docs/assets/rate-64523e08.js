import{a as e,o as d,j as a}from"./index-9017f177.js";const o={class:"markdown-body"},r=a(`<h2>Rate</h2><blockquote><p>1.5.0 新增</p></blockquote><p>评分组件。你可以自定义星星个数，可以禁用交互，以用作评价展示，可以通过插槽自定义星星样式。</p><h3>示例</h3><ul><li><p>基本用法</p><p>使用 v-model 对评分值双向绑定。</p><pre><code class="language-html">&lt;cube-rate v-model=&quot;value&quot;&gt;&lt;/cube-rate&gt;
