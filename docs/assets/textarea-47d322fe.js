import{a as d,o as e,j as a}from"./index-e8a96955.js";const o={class:"markdown-body"},r=a(`<h2>Textarea</h2><blockquote><p>1.5.0 新增</p></blockquote><p>多行输入框组件，支持使用<code>v-model</code>对数据双向绑定，根据是否有内容、是否聚焦有折叠、展开两种状态。</p><h3>示例</h3><ul><li><p>基本用法</p><p>使用<code>v-model</code>对输入内容双向绑定。</p><pre><code class="language-html">&lt;cube-textarea v-model=&quot;value&quot;&gt;&lt;/cube-textarea&gt;
